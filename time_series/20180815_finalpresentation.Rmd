...
- Simply: data points indexed by time order
- Natural temporal order of data
- Typically: Equally spaced points in time
- Often different than what we see in a regression setting
